    ...
    <div id="content">
        <div class="m-b-10">
            ...
            <div class="pull-right">
                <a href="<?php echo base_url('attraction/add_category'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Add Category</a>
            </div>
        </div>
                                            ...
                                            if (!empty($category_list)) {
                                                foreach ($category_list as $category) {
                                                    ...
                                                    <tr role="row" class="even">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('attraction/add_category/' . $category->id); ?>" class="btn btn-primary">Edit</a>
                                                            <a href="" class="delete btn btn-sm btn-default" data-record-id="<?php echo $category->id ?>" data-record-title="<?php echo $category->name ?>" data-toggle="modal" data-target="#confirm-delete">
                                                                Delete
                                                            </a>
                                                        </td>
                                                    </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
            ...
            var model = 'Attraction_Category_Model';
