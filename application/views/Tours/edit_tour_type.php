            ...
            <div data-widget-editbutton="false" id="8521cbb7b77c1acb05ccf76f73014447" class="jarviswidget jarviswidget-sortable" role="widget">
                <div role="content">
                    <div class="widget-body ">
                        ...
                        <form class="smart-form" id="country-form" novalidate="novalidate" data-parsley-validate="" novalidate="" method="post" enctype="multipart/form-data"  action="<?php echo base_url('tours/edit_tour_type/') ?><?php echo!empty($tour_type_data->id) ? '/' . $tour_type_data->id : null; ?>">
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <fieldset>
                                                    ...
                                                    <section>
                                                        ...
                                                        <label class="input"> 
                                                            <input type="text" placeholder="Enter Name" name="name" required="" value="<?php echo!empty($tour_type_data->name) ? $tour_type_data->name : null; ?>">
                                                        </label>
                                                    </section>
                                                    <section>
                                                    ...
                                                    <label class="textarea"> 										
                                                        <textarea name="tour_desc">
                                                                <?php echo!empty($tour_type_data->tour_desc) ? $tour_type_data->tour_desc : null; ?>
		                			</textarea>
                                                    </label>
                                                </section>
                                                     </fieldset>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <label class="textarea"> 										
                                                        <textarea name="short_desc">
                                                            <?php echo!empty($tour_type_data->short_desc) ? $tour_type_data->short_desc : null; ?>
		                			</textarea>
                                                    </label>
                                                </section>
                                                    ...
                                                    <section>
                                                        ...
                                                        <label class="input"> 
                                                            <input type="text" placeholder="Enter Weightage" name="weightage" required="" value="<?php echo!empty($tour_type_data->weightage) ? $tour_type_data->weightage : null; ?>">
                                                        </label>
                                                    </section>
                                            ...
                                            <div class="col-lg-12 col-sm-12">
                                                <fieldset>
                                                    <section>
                                                        ...
                                                        <div id="image_view">
                                                            <?php
                                                            if (!empty($tour_type_data->tour_images) && is_array($tour_type_data->tour_images)) {
                                                                    $tourImages = $tour_type_data->tour_images;
                                                                    $k = 0;
                                                                    for ($i = 0; $i < count($tourImages); $i++) {
                                                                        $imggPath = FCPATH . 'tour_image/' . $tourImages[$i]->image;
                                                                        $imggSrc = base_url('tour_image/' . $tourImages[$i]->image);
            ...
            $($(this)[0].files).each(function () {
                ...
                if (regex.test(file[0].name.toLowerCase())) {
                    ...
                    reader.onload = function (e) {
                        ...
                        var img = $("<img style='height:100px;width: 100px'/><a title='Remove fields row' class='remove_image' href=javascript:void(0);>X</a>");
