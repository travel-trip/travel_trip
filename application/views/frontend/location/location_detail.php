                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                <div class="explore-trip-cont">
                                    <p>
                                    <div class ="country-discover" style="max-height: 525px; overflow: hidden;"><?php echo !empty($details->long_desc) ? $details->long_desc : null; ?></div>
                                    
                                    <?php 
                                    $string_length = strlen($details->long_desc);
...
<?php if (!empty($locationAttraction[0]->attractions)) {
    $location_id = !empty($details->id) ? $details->id : null;
    ?>
        ...
        <div class="attraction-trip-outer">
            <div class="container">
                <div class="attraction-trip-main">
                    ...
                    <?php
                    $condition_array = array('location_id'=>$location_id);
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="attraction-trip-cont">
                                        ...
                                        <div id="carousel-example" class="carousel slide" data-ride="">
                                            <!-- Wrapper for slides -->
     ...
     $( document ).ready(function() {
        ...
        $('.explore-trip-cont').on('click','.more_link',function(){
            ...
            $(this).parent().find('.country-discover').css('max-height', 'none');
             ...
             $(this).parent().find('.country-discover').css('max-height', '525px');
     });
