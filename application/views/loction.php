    ...
    <div id="content">
        <div class="m-b-10">
            ...
            <div class="pull-right">
                <a href="<?php echo base_url('loction/add_loction'); ?>" class="btn btn-primary">
                            ...
                            <div class="widget-body no-padding">
                                <div id="dt_basic_wrapper" class="dataTables_wrapper form-inline no-footer">
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer" id="dt_basic" role="grid" aria-describedby="dt_basic_info" style="width: 100%;">
                                        <thead>			                
                                        <th>Name</th>
                                        <th>Parent Loction</th>
                                        <th>Description</th>
                                        <th class="sorting">Action</th>
                                        </thead>
                                        <tbody>
                                            <?php
                                            if (!empty($loction_list)) {
//                                                dump($loction_list);die;
                                                foreach ($loction_list as $loction) {
                                                    ?>
                                                    <tr role="row" class="even">
                                                        <td class=" expand">
                                                            <?php echo !empty($loction->loction) ? $loction->loction : '' ?>
                                                        </td>
                                                        <td class=" expand">
                                                            <?php echo ($loction->parent_id == '0') ? 'Self' : $loction->loction ?>
                                                        </td>
                                                        <td class=" expand">
                                                            <?php echo!empty($loction->short_description) ? $loction->short_description : '' ?>
                                                        </td>
                                                        <td>
                                                            <a href="<?php echo base_url('loction/updateLocationWithAttractions/'.$loction->id);?>" class="btn btn-primary">Edit</a>
                                                            <a href="" class="delete btn btn-sm btn-default" data-record-id="<?php echo $loction->id ?>" data-record-title="<?php echo $loction->loction ?>" data-toggle="modal" data-target="#confirm-delete">
                                                                Delete
                                                            </a>
                                                        </td>
                                                    </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
            ...
            var model = 'Loction_model';
            var msg = 'Selected Loction successfully deleted!';
