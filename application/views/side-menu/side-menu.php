<aside id="left-panel">
    ...
    <nav>
        ...
        <ul>
            <li class=""><a title="Location" href="#">
                    <i class="fa fa-lg fa-fw fa-location-arrow"></i><span class="menu-item-parent">Location </span>
                    <b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b></a>
                <ul style="display: none;">
                    <li class=""><a title="Country" href="<?php echo base_url('admin/country')?>">
                           Country
                        </a>
                    </li>
                    <li>
        ...
        <ul>
            <li class="">
                ...
                <ul style="display: none;">
                    ...
                    <li class="">
                        <a title="Attraction Category" href="<?php echo base_url().'attraction/category'?>">
                           Attraction Category
                        </a>
                    </li>
